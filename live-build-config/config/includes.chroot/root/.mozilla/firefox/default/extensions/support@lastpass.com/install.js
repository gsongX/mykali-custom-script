...
var locales             = [ "af-ZA", "ar-SA", "ar-EG", "az-AZ", "bg-BG", "bn-BD", "bs-BA", "ca-ES", "cs-CZ", "da-DK", "de-DE", "el-GR", "en-GB", "en-US", "eo-US", "es-ES", "es-MX", "et-EE", "fa-IR", "fi-FI", "fr-FR", "fr-CA", "gl-ES", "gu-IN", "he-IL", "hi-IN", "hr-HR", "hu-HU", "id-ID", "is-IS", "it-IT", "ja-JP", "ka-GE", "ko-KR", "lt-LT", "lv-LV", "mg-MG", "mk-MK", "ms-MY", "nl-NL", "nn-NO", "nb-NO", "pa-IN", "pl-PL", "pt-BR", "pt-PT", "ro-RO", "ru-RU", "sk-SK", "sl-SI", "sq-AL", "sr-RS", "sv-SE", "ta-IN", "th-TH", "tl-PH", "tr-TR", "uk-UA", "ur-PK", "vi-VN", "zh-CN", "zh-TW" ];
var skins               = [  ]; // "modern"
